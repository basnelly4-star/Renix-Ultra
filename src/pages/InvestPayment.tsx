...
const InvestPayment = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Investment payment submitted! Awaiting confirmation.");
      navigate("/upgrade-pending");
    } catch (err) {
      toast.error("Failed to submit investment payment");
    } finally {
      setUploading(false);
    }
  };
    ...
    <div className="min-h-screen liquid-bg pb-20">
      <div className="bg-gradient-to-r from-primary to-secondary p-6 text-primary-foreground">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Complete Investment Payment</h1>
        </div>
      </div>
            ...
            <div className="bg-muted/50 p-4 rounded-lg space-y-2">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex items-center justify-between">
                  <p className="font-mono">Account:2016759708</p>
                  <CopyButton text="2016759708" />
                </div>
                <p>Name:  Michael Michael</p>
                <p>Bank: FairMoney MFB  </p>
              </div>
            </div>
